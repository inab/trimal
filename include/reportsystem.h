...
public:
    ...
    static const std::map<ReportSystem::InfoCode, const char *>       InfoMessages ;
    static const std::map<ReportSystem::WarningCode, const char *>    WarningMessages ;
    static const std::map<ReportSystem::ErrorCode, const char *>      ErrorMessages ;
     ...
     */
    static void PrintCodesAndMessages();
     ...
     */
    static void Report(ErrorCode message, std::string * vars = NULL);
     ...
     */
    static void Report(ErrorCode message, char * vars);
    /**
    ...
    <b> The method will take care of destroying the pointer </b>
    */
    static void Report(WarningCode message, std::string * vars = NULL);
    /**
     ...
     <b> The method wont take care of destroying the pointer </b> This allows to reuse the parameter passed.
     */
    static void Report(WarningCode message, char * vars);
    /**
    ...
    <b> The method will take care of destroying the pointer </b>
    */
    static void Report(InfoCode message, std::string * vars = NULL);
    /**
     \brief Method to report a Info message. It will be displayed if VerboseManager::Level is equal or higher to VerboseManager::VerboseLevel::Info
     \param message Code to report.
     \param vars Array of chars that will replace the first aparition of '[tags]' in the message. \n
