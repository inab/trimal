                                            ...
                                            std::toupper(sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1]) == std::toupper(ref[0]))
                                    {
                                        ...
                                        if (strlen(alt) > 1)
                                        {
                                            ...
                                            if (c == maxlen + 1)
                                            {
                                                ...
                                                // Two Bases
                                                case 3:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'M';
                                                    break; // aMine AC
                                                case 5:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'W';
                                                    break; // Weak AT
                                                case 9:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'R';
                                                    break; // puRine AG
                                                case 6:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'Y';
                                                    break; // pYrimidine CT
                                                case 10:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'S';
                                                    break; // Strong CG
                                                case 12:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'K';
                                                    break; // Keto TG

                                                // Three Bases
                                                case 14:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'B';
                                                    break; // CTG not A
                                                case 13:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'D';
                                                    break; // ATG not C
                                                case 11:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'V';
                                                    break; // ACG not T
                                                case 7:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'H';
                                                    break; // ACT not G

                                                // All Four Bases
                                                case 15:
                                                    sources[i]->sequences[donorsPositions[C][counter] + 1][position - 1] = 'N';
                                                    break; // ACTG
                                                default:
                                                    break;
                                                }
