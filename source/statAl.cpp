/* ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** *****
   ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** ***** *****
    ...
    statsAl v1.4: a tool for getting different stats about alignments
...
int main(int argc, char *argv[]){
  ...
  /* Parameters Control */
  bool appearErrors = false, sgc = false, sgt = false, scc = false, sct = false, sfc = false,
       sft = false, sident = false;

  int compareset = -1, stats = 0, windowSize = -1, gapWindow = -1, simWindow = -1, conWindow = -1,
