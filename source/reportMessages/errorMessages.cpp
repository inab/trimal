...
const std::map<ErrorCode, const char *> reporting::reportManager::ErrorMessages =
{
    ...
    {ErrorCode::SelectSeqsResAndAutomathedMethodsIncompatibilities,
            "Options -selectCols and -selectSeqs are not allowed in combination with automated trimming options: (-nogaps || -noallgaps || -gappyout || -strict || -strictplus || -automated1 || -automated2 || -automated3)."},
